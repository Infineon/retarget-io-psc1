 ...
 *
 * \brief
 * Provides APIs for transmitting messages to or from the PSC1M3 board via standard
 ...
 * what went wrong
 */
cy_rslt_t cy_retarget_io_init(Cy_USIC_CH_t* channel);
